...
BOT_NAME = os.environ.get("BOT_NAME", "ZP Music")
...
async def start_handler(_, message):
    ...
    updates_channel = os.getenv("UPDATES_CHANNEL", "https://t.me/haipalkon")
    support_group = os.getenv("SUPPORT_GROUP", "https://t.me/zplog")
